import { prime, buildGoal } from "./prime.js";
import { record } from "./recorder.js";
import { MOCK_ENABLED, getMockResponse } from "./mock.js";
export async function run(options) {
    ...
    // Step 3: record
    const outcome = { domain, goal, success, steps, errors, raw, durationMs };
...
async function callTinyFish(url, goal, silent) {
        ...
        for (const line of lines) {
            ...
            try {
                ...
                if (event.type === "PROGRESS" && event.purpose) {
                    ...
                    if (!silent)
                        process.stdout.write(`  · ${event.purpose}\n`);
                }
