...
import type { DomainStore, Hint, RunOutcome, RunHistoryEntry } from "./types.ts"
import { readStore, storePath } from "./reader.ts"
import config from "../mycelium.config.ts"

export function writeStore(store: DomainStore): void {
...
export function mergeHints(store: DomainStore, newHints: Hint[]): DomainStore {
